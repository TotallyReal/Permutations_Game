...
public class PolygonCutter : MonoBehaviour
{
    ...
    {
        surface.OnVertexPressed += Surface_OnVertexPressed;
    ...
    private void Surface_OnVertexPressed(object sender, Vertex.VertexId e)
    {

        if (selectedPolygon == null)
        {
            Vector3 vertex = e.position;
            selectedPolygon = e.polygon;
            selectedVertexId = e.vertexID;
            vertex.z = -1;
