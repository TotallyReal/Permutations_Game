...
{  /* 
    ...
    [SerializeField] private int midiKey = 25;
    ...
    public void changePitch(int keyNumber, float pitch)
    {
        ...
        {
            UnityEngine.Debug.Log("Not yet here");
        }
    }
    ...
    void Pulse()
    {
        UnityEngine.Debug.Log("Play-Pause");
    ...
    void OnAudioFilterRead(float[] data, int channels)
    {
        ...
        {
            UnityEngine.Debug.Log("Accesing while changing the frequency");
        }
